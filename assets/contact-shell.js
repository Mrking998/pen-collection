(function(){
  ...
  shell.innerHTML='<button class="contact-trigger" type="button" aria-expanded="false" aria-controls="contact-actions" aria-haspopup="menu" aria-label="Open contact options"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.2 4.5h2.1l1 4-1.7 1.5a14.5 14.5 0 0 0 5.4 5.4l1.5-1.7 4 1v2.1c0 1.2-1 2.2-2.2 2.2A12.3 12.3 0 0 1 5 6.7c0-1.2 1-2.2 2.2-2.2Z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg></button><div class="contact-panel" id="contact-actions" role="menu" aria-label="Contact options" hidden><a role="menuitem" href="tel:+2348930790672"><span aria-hidden="true">☎</span><span><b>Call</b><small>+234 893 079 0672</small></span></a><a role="menuitem" data-whatsapp href="https://wa.me/2348930790672" target="_blank" rel="noopener"><span aria-hidden="true">◉</span><span><b>WhatsApp</b><small>Message customer care</small></span></a></div>';
  ...
  enrich(panel.querySelector('[data-whatsapp]'));
